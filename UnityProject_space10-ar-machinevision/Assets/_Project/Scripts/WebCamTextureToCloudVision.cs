...
public class WebCamTextureToCloudVision : MonoBehaviour {
	...
	void Sample_OnAnnotateImageResponses(AnnotateImageResponses responses) {
		if (responses.responses.Count > 0) {
			...
			if (responses.responses[0].localizedObjectAnnotations != null && responses.responses[0].localizedObjectAnnotations.Count > 0) {
				Debug.Log("localizedObjectAnnotations: " + responses.responses[0].localizedObjectAnnotations[0].name);
				Debug.Log("localizedObjectAnnotations: " + responses.responses[0].localizedObjectAnnotations[0].boundingPoly.normalizedVertices[0].x);
			}
		}
	}
}
